  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
        ...
        {/* Hero Section */}
        <div className="relative mb-10 min-h-screen w-full overflow-hidden rounded-xl" style={{ background: 'linear-gradient(135deg, #3186e7 0%, #1a5bb8 100%)' }}>
          {/* Background Elements */}
        ...
        {/* Contact Section */}
        <section id="contact" className="py-12 sm:py-16 lg:py-20 xl:py-24 bg-gradient-to-r from-blue-800 to-blue-600 rounded-xl">
