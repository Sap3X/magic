...
import { Menu, X, Phone, MapPin, ChevronLeft, ChevronRight } from 'lucide-react';
  ...
  return (
    <div className="w-full max-w-7xl mt-11 mx-auto py-8 px-4 lg:py-16">
      <div className="text-center mb-8 lg:mb-12">
        <h2 className="text-2xl md:text-4xl font-bold text-[black] mb-4">Our Partners</h2>
          ...
          <div className="flex-1 overflow-hidden">
            <div 
              ...
              style={{
                ...
                marginLeft: `calc(50% - ${partnersPerView * (280 + 16) / 2}px)`
              }}
            >
      ...
      <div ref={statsRef} className="mt-12 lg:mt-16 grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-8 text-center">
        <div className="bg-white rounded-lg p-4 lg:p-6 shadow-md transform hover:scale-105 transition-transform duration-300">
          ...
          <div className="text-gray-600 text-sm lg:text-base">Strategic Partners</div>
        </div>
        <div className="bg-white rounded-lg p-4 lg:p-6 shadow-md transform hover:scale-105 transition-transform duration-300">
          <div className="text-2xl lg:text-3xl font-bold text-green-600 mb-2">
            {counters.projects}+
          </div>
          <div className="text-gray-600 text-sm lg:text-base">Collaborative Projects</div>
        </div>
        <div className="bg-white rounded-lg p-4 lg:p-6 shadow-md transform hover:scale-105 transition-transform duration-300">
          <div className="text-2xl lg:text-3xl font-bold text-purple-600 mb-2">
            {counters.countries}
          </div>
          <div className="text-gray-600 text-sm lg:text-base">Countries Reached</div>
        </div>
      </div>
    </div>
  );
    ...
    switch(selectedBox) {
      case 'box1':
        return {
          ...
          content: "Discover the world of robotics and artificial intelligence with our comprehensive Box-1 kit. This package includes programmable robots, sensors, actuators, and step-by-step tutorials designed to teach fundamental concepts of robotics, programming, and AI. Perfect for students aged 10-16 to develop problem-solving skills and computational thinking."
        };
      case 'box2':
        return {
          title: "STEM Exploration Kit",
          content: "Unleash creativity with our advanced STEM exploration kit in Box-2. This collection features electronic components, circuit boards, motors, and innovative building materials. Students will learn electronics, engineering principles, and hands-on construction while building real-world projects that demonstrate scientific concepts in action."
        };
      default:
        return {
          title: "Complete Learning Solution",
          content: "Transform the way STEM, AI, and Robotics are taught with our comprehensive Anubhav Kits. Designed for hands-on learning and innovation."
        };
    }
  };
    ...
    <div className="min-h-screen bg-gray-200">
      ...
      <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-gray-400 via-gray-300 to-gray-200">
        ...
        <div className="absolute inset-0 opacity-30">
          <svg className="absolute top-10 left-20 w-32 h-40 rotate-12" viewBox="0 0 100 120" fill="none">
            <path d="M10 10 Q30 20 25 40 T50 60 Q60 80 45 100" stroke="currentColor" strokeWidth="2" className="text-gray-600"/>
          </svg>
          <svg className="absolute top-32 right-32 w-24 h-32 -rotate-45" viewBox="0 0 80 100" fill="none">
            <path d="M5 5 Q20 15 15 30 T40 50 Q50 70 35 85" stroke="currentColor" strokeWidth="2" className="text-gray-600"/>
          </svg>
          <svg className="absolute bottom-40 left-40 w-28 h-36 rotate-45" viewBox="0 0 90 110" fill="none">
            <path d="M8 8 Q25 18 20 35 T45 55 Q55 75 40 90" stroke="currentColor" strokeWidth="2" className="text-gray-600"/>
          </svg>
          <svg className="absolute bottom-20 right-20 w-20 h-28 -rotate-12" viewBox="0 0 70 90" fill="none">
            <path d="M6 6 Q18 12 16 25 T35 45 Q42 60 30 75" stroke="currentColor" strokeWidth="2" className="text-gray-600"/>
          </svg>
        </div>
        ...
        <div className="relative z-10 flex items-center justify-center min-h-[70vh] pt-32 pb-8 px-2 sm:px-4 lg:px-8 mb-24">
          <div className="grid lg:grid-cols-2 items-center max-w-7xl mx-auto gap-8">
            ...
            >
              <div className="relative">
                ...
                <div className="absolute -top-6 -left-6 w-10 h-10 sm:w-12 sm:h-12 bg-white rounded-full flex items-center justify-center shadow-lg animate-bounce">
                  <span className="text-[#FFA500] font-bold text-xs sm:text-sm">AI</span>
                </div>
                <div className="absolute -bottom-4 -right-4 w-12 h-12 sm:w-16 sm:h-16 bg-[#FFA500] rounded-full flex items-center justify-center shadow-lg animate-pulse">
                  <span className="text-white font-bold text-[10px] sm:text-xs">STEM</span>
                </div>
              </div>
            </div>
            ...
            <div className="text-center lg:text-left order-1 lg:order-2">
              ...
              <div className={`text-lg sm:text-2xl md:text-3xl lg:text-4xl font-bold font-['Inter'] mb-8 text-gray-700 opacity-0 ${isLoaded ? 'animate-slide-in-right animation-delay-200' : ''}`}>
                <span className="block">Together Let us</span>
                <span className="block">Innovate Create Learn</span>
              </div>
              <p className={`text-gray-600 text-base sm:text-lg md:text-xl lg:text-2xl font-medium max-w-lg mx-auto lg:mx-0 mb-8 opacity-0 ${isLoaded ? 'animate-slide-in-up animation-delay-400' : ''}`}>
                Transform education with hands-on STEM, AI, and Robotics learning experiences that inspire the next generation of innovators.
              </p>
              {/* CTA Buttons */}
              <div
                className={`
          ...
          <div className="relative group w-full max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl h-72 sm:h-96 md:h-[32rem] lg:h-[36rem] flex items-center justify-center">
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white/60 group-hover:scale-105 group-hover:shadow-[0_8px_40px_0_rgba(255,168,0,0.15)] transition-all duration-150 animate-bounce-slow">
              <img
                ...
                src={selectedBox === 'box2' ? img4 : selectedBox === 'box1' ? img5 : img1}
                alt="Anubhav Kit"
        ...
        <div className="order-1 lg:order-2 space-y-10">
          ...
          <div className="flex flex-row gap-3 sm:gap-6">
            <button 
              ...
              className={`
                ${selectedBox === 'box1' ? 'bg-[#FFA500] ring-4 ring-[#FFA500]/30 shadow-2xl scale-105' : 'bg-[#FFB84D] hover:bg-[#FFA500] shadow-lg hover:shadow-xl'}
                rounded-3xl
                px-4 py-4
                sm:px-10 sm:py-8
                flex-1
            ...
            >
              <div className="relative z-10">
                ...
                <p className="text-white/80 text-xs sm:text-base md:text-lg mt-1 sm:mt-3 font-medium">Robotics & AI</p>
              </div>
            </button>
            <button 
              onClick={handleBox2Click}
              className={`
                ${selectedBox === 'box2' ? 'bg-[#FFA500] ring-4 ring-[#FFA500]/30 shadow-2xl scale-105' : 'bg-[#FFB84D] hover:bg-[#FFA500] shadow-lg hover:shadow-xl'}
                rounded-3xl
                px-4 py-4
                sm:px-10 sm:py-8
                flex-1
            ...
            >
              <div className="relative z-10">
                ...
                <p className="text-white/80 text-xs sm:text-base md:text-lg mt-1 sm:mt-3 font-medium">STEM Explorer</p>
              </div>
            </button>
          </div>
          <div
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="mt-8 flex gap-3">
                <div className={`h-2 flex-1 rounded-full transition-all duration-200 ${selectedBox === 'box1' ? 'bg-[#FFA500]' : 'bg-gray-200'}`}></div>
                <div className={`h-2 flex-1 rounded-full transition-all duration-200 ${selectedBox === 'box2' ? 'bg-[#FFA500]' : 'bg-gray-200'}`}></div>
              </div>
            </div>
          </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-8 lg:mb-16">
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-gray-800 mb-4 lg:mb-6 font-['Montserrat']">
                Why Choose <span className="text-[#ff8d00] font-extrabold drop-shadow-sm">ANUBHAV</span>?
              </h2>
              <p className="text-lg sm:text-xl lg:text-2xl text-gray-600 max-w-3xl mx-auto">
                Discover the revolutionary features that make our kits the perfect choice for modern education
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-12 lg:mb-20">
              ...
              <div className="group relative bg-white rounded-2xl lg:rounded-3xl p-6 lg:p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 cursor-pointer overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-600 text-sm lg:text-base leading-relaxed group-hover:text-gray-700 transition-colors duration-300">
                    Interactive experiments and projects that bring theoretical concepts to life through practical application
                  </p>
                </div>
              ...
              <div className="group relative bg-white rounded-2xl lg:rounded-3xl p-6 lg:p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 cursor-pointer overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-600 text-sm lg:text-base leading-relaxed group-hover:text-gray-700 transition-colors duration-300">
                    Cutting-edge technology components that introduce students to the future of artificial intelligence and robotics
                  </p>
                </div>
              ...
              <div className="group relative bg-white rounded-2xl lg:rounded-3xl p-6 lg:p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 cursor-pointer overflow-hidden md:col-span-2 lg:col-span-1">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-600 text-sm lg:text-base leading-relaxed group-hover:text-gray-700 transition-colors duration-300">
                    Perfectly designed to complement existing STEM curricula while enhancing teaching methodologies
                  </p>
                </div>
            ...
            <div className="bg-gradient-to-r from-[#FFA500] to-[#FF8C00] rounded-2xl lg:rounded-3xl p-6 lg:p-12 text-white">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
                <div className="group text-center cursor-pointer">
                  ...
                  <h4 className="text-lg lg:text-xl font-semibold mb-2 lg:mb-3">Unbox & Explore</h4>
                  <p className="text-sm lg:text-base opacity-90 group-hover:opacity-100 transition-opacity duration-300">
                    Start with guided tutorials and basic component familiarization
                  </p>
                </div>
                ...
                <div className="group text-center cursor-pointer">
                  ...
                  <h4 className="text-lg lg:text-xl font-semibold mb-2 lg:mb-3">Build & Create</h4>
                  <p className="text-sm lg:text-base opacity-90 group-hover:opacity-100 transition-opacity duration-300">
                ...
                <div className="group text-center cursor-pointer">
                  ...
                  <h4 className="text-lg lg:text-xl font-semibold mb-2 lg:mb-3">Innovate & Share</h4>
                  <p className="text-sm lg:text-base opacity-90 group-hover:opacity-100 transition-opacity duration-300">
      ...
      <section className="py-12 lg:py-24 bg-gradient-to-r from-orange-500 to-amber-500">
        <div className="max-w-7xl mx-auto px-4 lg:px-20 text-center">
          ...
          <p className="text-white text-lg md:text-2xl lg:text-3xl xl:text-4xl font-semibold font-['Nunito_Sans'] mb-6 lg:mb-12 max-w-4xl mx-auto">
            Transform the way STEM, AI, and Robotics are taught. Contact us to bring Anubhav to your school today!
          </p>
