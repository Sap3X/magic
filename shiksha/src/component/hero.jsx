    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-500 to-red-400">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center justify-between min-h-screen py-8 sm:py-12 lg:py-0">
            ...
            <div className={`transform transition-all duration-1500 ${
              ...
              <h1 className="text-3xl xs:text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black mb-4 sm:mb-6 leading-tight">
                <span className="inline-block bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent hover:scale-100 transition-transform duration-400 cursor-default">
                  <span className="animate-pulse" style={{ animationDuration: '2s' }}>S</span>
                  <span className="animate-pulse" style={{ animationDuration: '2s', animationDelay: '0.1s' }}>H</span>
                  <span className="animate-pulse" style={{ animationDuration: '2s', animationDelay: '0.2s' }}>I</span>
                  <span className="animate-pulse" style={{ animationDuration: '2s', animationDelay: '0.3s' }}>K</span>
                  <span className="animate-pulse" style={{ animationDuration: '2s', animationDelay: '0.4s' }}>S</span>
                  <span className="animate-pulse" style={{ animationDuration: '2s', animationDelay: '0.5s' }}>H</span>
                  <span className="animate-pulse" style={{ animationDuration: '2s', animationDelay: '0.6s' }}>A</span>
                </span>
                <span className="block xs:inline-block bg-gradient-to-r from-blue-900 to-red-700 bg-clip-text text-transparent hover:scale-100 transition-transform duration-500 cursor-default animate-bounce font-Conthrax mt-2 xs:mt-0" 
            ...
            <div className={`transform transition-all duration-1500 delay-700 ${
              ...
              <div className="relative mb-6 sm:mb-8">
                <p className="text-base xs:text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold text-slate-200 leading-relaxed">
                  <span className="inline-block text-blue-900 text-xl xs:text-2xl sm:text-3xl md:text-4xl animate-pulse">"</span>
                ...
                {/* Dynamic Underline */}
                <div className="mt-3 sm:mt-4 h-1 bg-gradient-to-r from-transparent via-blue-400 to-transparent rounded-full transform origin-center animate-pulse"
                     style={{ 
          ...
          <div className="flex-1 flex justify-center lg:justify-end relative">
            <div className={`relative transform transition-all duration-2000 delay-500 ${
              isVisible ? 'translate-y-0 opacity-100 scale-100' : 'translate-y-32 opacity-0 scale-75'
            }`}>
              
              {/* Orbital Rings */}
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-72 h-72 xs:w-80 xs:h-80 sm:w-96 sm:h-96 md:w-[28rem] md:h-[28rem] lg:w-[32rem] lg:h-[32rem] border border-blue-400/20 rounded-full animate-spin opacity-60"
                     style={{ animationDuration: '20s' }} />
                <div className="absolute w-64 h-64 xs:w-72 xs:h-72 sm:w-80 sm:h-80 md:w-96 md:h-96 lg:w-[26rem] lg:h-[26rem] border border-purple-400/20 rounded-full animate-spin opacity-40"
                     style={{ animationDuration: '15s', animationDirection: 'reverse' }} />
                <div className="absolute w-56 h-56 xs:w-64 xs:h-64 sm:w-72 sm:h-72 md:w-80 md:h-80 lg:w-96 lg:h-96 border border-pink-400/20 rounded-full animate-spin opacity-30"
              ...
              <div className="absolute -top-4 -left-4 xs:-top-6 xs:-left-6 sm:-top-8 sm:-left-8 w-10 h-10 xs:w-12 xs:h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-2xl flex items-center justify-center text-white text-lg xs:text-xl sm:text-2xl shadow-lg animate-bounce z-30"
                   style={{ animationDelay: '0.5s', animationDuration: '3s' }}>
                
                🤖

              </div>
              <div className="absolute -bottom-4 -right-4 xs:-bottom-6 xs:-right-6 sm:-bottom-8 sm:-right-8 w-10 h-10 xs:w-12 xs:h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-gradient-to-r from-green-500 to-emerald-500 rounded-2xl flex items-center justify-center text-white text-lg xs:text-xl sm:text-2xl shadow-lg animate-bounce z-30"
              ...
              <div className="absolute top-2/3 -left-6 xs:-left-8 sm:-left-10 md:-left-12 w-8 h-8 xs:w-10 xs:h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl flex items-center justify-center text-white text-sm xs:text-base sm:text-lg md:text-xl shadow-lg animate-bounce z-30"
      ...
      <style jsx>{`
        ...
        @keyframes robotFloat {
          ...
          25% { transform: translateY(-15px) rotateX(2deg); }
